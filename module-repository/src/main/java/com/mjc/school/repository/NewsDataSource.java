...
public class NewsDataSource {
    private static final NewsDataSource newsDataSource = new NewsDataSource();
    ...
    static {
        try {
            ...
            List<Author> authors = AuthorDataSource.getAuthorDataSource().getAuthors();
    ...
    public static NewsDataSource getAuthorDataSource () {
